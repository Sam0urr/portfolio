...
<Img src="/images/notes/yap-rai-stone.jpg" alt="A large rai stone disc with a central hole, set on a stone base in the Yap forest." class="note-side-photo" widths={[220, 440]} sizes="220px" eager>Source: <a href="https://en.wikipedia.org/wiki/Rai_stones">Wikipedia, <em>Rai stones</em></a>.</Img>
...
<Img src="/images/notes/yap-rai-stones-row.jpg" alt="A row of rai stones of varying sizes lined up along a path on Yap." class="note-side-photo-left" widths={[220, 440]} sizes="220px">Source: <a href="https://www.instagram.com/p/DMAVpqhtf_C/?img_index=1">@thisisancient on Instagram</a> — worth scrolling through the carousel.</Img>
