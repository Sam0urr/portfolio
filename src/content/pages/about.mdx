...
<Img src="/images/about.jpg" alt="Sam Lamrabte" class="float-right ml-6 mb-4 w-[36%] max-w-[280px] max-sm:float-none max-sm:mx-auto max-sm:mb-6 max-sm:w-full [&_img]:aspect-[4/5] [&_img]:w-full [&_img]:object-cover [&_img]:object-[center_25%] [&_img]:rounded-2xl [&_img]:shadow-lg dark:[&_img]:shadow-black/50" />
...
<figure class="my-14 mb-6 mx-auto block max-w-[700px] p-0 text-accent [&_svg]:block [&_svg]:h-auto [&_svg]:w-full max-[520px]:[&_text]:text-[13px]" aria-label="Cities where I have studied and worked">
