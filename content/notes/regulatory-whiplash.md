...
canonical: "https://sam0urr.github.io/portfolio/notes/regulatory-whiplash/"
...
The EU Deforestation Regulation? [Postponed on 23 December 2025](https://www.cliffordchance.com/insights/resources/blogs/business-and-human-rights-insights/2026/02/omnibus-i-the-european-union-concludes-csddd-and-csrd-reforms.html) (one week before it was due to apply), pushing large operators to December 2026. The sustainability reporting you'd staffed up for? Your company probably just fell out of scope entirely. The AI Act obligations you were racing toward an August 2026 deadline to meet? Deferred to December 2027, maybe, pending a text that at the time of writing still isn't formally law. Your two new hires are now working against deadlines that may move again. Your board wants to know why you spent the money.
...
Two big "omnibus" packages reshaped the European rulebook in a matter of months, both flowing from the same source: the [Competitiveness Compass](https://www.etifor.com/en/whats-going-on/pacchetto-omnibus-csrd-csddd/), the Commission's January 2025 roadmap built on the Draghi report, which set an explicit target of cutting reporting burdens by 25%. Deregulation stopped being an instinct and became a KPI.

**The Sustainability Omnibus (Omnibus I)** entered into force on [18 March 2026](https://www.dlapiper.com/en-us/insights/blogs/environment-health-safety-and-product-compliance/2026/eu-omnibus-i-directive-amending-csrd-and-csddd-will-enter-into-force-on-18-march-2026). It did three dramatic things. It narrowed CSRD scope to companies with [over 1,000 employees and €450M turnover](https://www.europarl.europa.eu/legislative-train/package-simplification-business/file-first-omnibus-package-on-sustainability-proposal-amending-csrd-and-csddd), cutting a regime originally [designed to cover roughly 50,000 companies](https://www.climatepartner.com/en/knowledge/blog/csrd-after-the-omnibus) down to a fraction of that. It raised the CSDDD due-diligence threshold to [5,000 employees and €1.5bn turnover](https://www.etifor.com/en/whats-going-on/pacchetto-omnibus-csrd-csddd/) and pushed application to 2029. And it stripped out substance: the EU-wide [civil liability regime was deleted](https://www.cliffordchance.com/insights/resources/blogs/business-and-human-rights-insights/2026/02/omnibus-i-the-european-union-concludes-csddd-and-csrd-reforms.html), the Paris-aligned transition-plan obligation removed, and the reporting standards themselves cut by a [61% reduction in mandatory data points](https://www.etifor.com/en/whats-going-on/pacchetto-omnibus-csrd-csddd/).

**The Digital (AI) Omnibus** reached [provisional agreement on 7 May 2026](https://www.whitecase.com/insight-alert/eu-agrees-eu-agrees-digital-omnibus-deal-simplify-ai-rules), the first amendment to the AI Act since it passed. It deferred high-risk obligations on a staggered schedule (standalone Annex III systems from August 2026 to [December 2027, embedded systems to August 2028](https://www.gibsondunn.com/eu-ai-act-omnibus-agreement-postponed-high-risk-deadlines-and-other-key-changes/)) and gave standards bodies like CEN-CENELEC more time because implementation was, in the regulators' own words, [visibly off track](https://www.gibsondunn.com/eu-ai-act-omnibus-agreement-postponed-high-risk-deadlines-and-other-key-changes/).

Here is the part that matters most for our compliance lead, and the part the headlines bury: **the delay is not permission to stop.** Until the AI Omnibus is formally published in the Official Journal, [2 August 2026 remains a live compliance date](https://www.gibsondunn.com/eu-ai-act-omnibus-agreement-postponed-high-risk-deadlines-and-other-key-changes/): lawyers are explicitly telling clients to keep preparing against the old deadline. And the political agreement itself [underscores the expectation that implementation efforts should already be underway](https://www.hoganlovells.com/en/publications/eu-legislators-agree-to-delay-for-highrisk-ai-rules). So the organisation is asked to hold two contradictory futures in its head at once: prepare as if the deadline is August 2026, but plan as if it's December 2027. That is not relief. That is whiplash.
...
- **Gibson Dunn, ["EU AI Act Omnibus Agreement"](https://www.gibsondunn.com/eu-ai-act-omnibus-agreement-postponed-high-risk-deadlines-and-other-key-changes/).** The cleanest statement of the "2 August 2026 remains a live compliance date" point: essential for understanding why the delay creates work rather than removing it.
- **Clifford Chance, ["Omnibus I: the EU concludes CSDDD and CSRD reforms"](https://www.cliffordchance.com/insights/resources/blogs/business-and-human-rights-insights/2026/02/omnibus-i-the-european-union-concludes-csddd-and-csrd-reforms.html).** Best on the *substance* removed (civil liability, transition plans) and the EUDR's week-before-the-wire postponement.
- **Etifor, ["Omnibus I: what changes for the CSRD and CSDDD"](https://www.etifor.com/en/whats-going-on/pacchetto-omnibus-csrd-csddd/).** Connects the cuts explicitly back to the Competitiveness Compass and the 25% burden-reduction target: the political-economy through-line.
- **TechPolicy.Press, ["What the EU AI Omnibus Deal Changes"](https://www.techpolicy.press/what-the-eu-ai-omnibus-deal-changes-for-the-ai-act-and-what-lies-ahead/).** Useful counterweight: notes that *both* industry and civil society came away frustrated, and that the Data Omnibus is the bigger fight still coming.
