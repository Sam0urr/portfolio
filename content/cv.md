...
- **Analytical:** structured problem-solving, comparative analysis, framework design, KPI reporting, business intelligence; data analysis (Python, SPSS, advanced Excel).
- **Digital & AI governance:** AI Act, GDPR, DSA, CSRD, CSDDD, platform governance, digital methods; Power BI, ArcGIS.
- **Project & operations:** project management, workflow design, process improvement, Agile, CRM/ERP systems.
- **Stakeholder:** multi-stakeholder coordination, client management, multilingual communication, cross-functional collaboration.
